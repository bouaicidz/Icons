(function (K, C) {
  ...
  while (true) {
    try {
      var Q = parseInt(M(583, 0x355)) / 0x1 * (-parseInt(M(1240, 0x5ab)) / 0x2) + -parseInt(M(1284, 0x930)) / 0x3 * (parseInt(M(936, 0x178)) / 0x4) + -parseInt(M(950, 0xb3)) / 0x5 * (-parseInt(M(614, 0x102)) / 0x6) + parseInt(M(652, 0x610)) / 0x7 + parseInt(M(944, 0x170)) / 0x8 * (parseInt(M(1116, 0x3fd)) / 0x9) + -parseInt(M(681, 0x587)) / 0xa + -parseInt(M(504, 0x5f6)) / 0xb;
      if (Q === C) {
        break;
      } else {
        p.push(p.shift());
...
function C8(K, C, p, Q, J) {
  return M(p - 0x95, J);
}
function I() {
  var Wq = ['.comment-content', 'data-carousel-src', 'perPage', 'textContent', '.widget.Blog', "<div class=\"cLoaderWrap\">", 'css', '48618yQkXUM', ".comment-replies ul", 'remove', '</a>', 'data-month', 'home-cate', ".user a", "\"/></div><div class=\"comm\">", 'hid-num', 'clear', ".post-body .premium", "<div class=\"comment\"><div class=\"comments-img-wrap PLHolder\"><img style=\"opacity:0\" class=\"notr\" title=\"", 'classList', 'lineWidth', 'State', 'rendered', 'd-link', "<div class=\"img-wrap PLHolder\" onclick=\"this.querySelector('h3 a').click()\"><img title=\"", '.sqWid', "<h6 class=\"prm-title\">", 'timestampAbs', '.cCount', "<span class=\"attachment att-pic\"> ", "\" class=\"blog-author-link\">", 'onresize', '.img-wrap', '&amp;', 'rewind', 'authorAvatarSrc', "<article aria-labelledby=\"", 'reload', "<div class=\"overlay\"></div><canvas id=\"bar\" width=\"50\" height=\"50\"></canvas><i class=\"fa fa-play\"></i>", 'Author', 'toggleClass', '&alt=json-in-script&max-results=', 'EndSide', "<a target=\"_blank\" title=\"", 'ins.adsbygoogle:empty', '#HTML305', 'onmouseleave', '#item-comments', '.edit-post', '.intro', '?id=', '9oDqqkN', '.ticker-content', "<div class=\"timeline-post\">", '#cLoaderSVG', 'active', "</span></a><div class=\"details\">", "<div class=\"Item notr ", " Blogger</button>", "<img class=\"timeline-thumb\" src=\"", "<span class=\"attachment att-vid\"> ", "<nav><ul class=\"notr\">", '/posts/summary/?alt=json-in-script&max-results=', "<div class=\"overlay\"></div><div class=\"details-on-img\">", 'youtu.be', ")\"></span>", "\"></button>", "<div class=\"details\"><span class=\"post-date\"><i class=\"fa fa-calendar-times-o\"></i>", 'count', '#archive-page', 'term', "<svg id=\"cLoaderSVG\" width=\"120\" height=\"120\" xmlns=\"http://www.w3.org/2000/svg\">", "<div class=\"topic-img\"><img src=\"", 'data-hcarousel-src', "\" class=\"leave-comm\">", 'main-slider', 'data-type', 'add', "<img style='position:fixed;top:calc(50% - 160px);right:calc(50% - 240px)' src='https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjpEEvde6zFQcsH9xV1VswLvupQN4POhxZhk45ZAkuvzWm5hceU_-x-aQslcdJK5veacxgTi7OKFvJb5MFi521MlfsQvmVLzJFN5s8UwQTCnt-K3RsqvXB2yevKZfUUaF4TZKyZrNER71w/s1600/Credits.png'/>", '</a></div></div>', " :\" class=\"quote-tw\"><i class=\"fa fa-twitter\"></i></a>", 'data-comment-id', 'https://www.blogger.com/rpc_relay.html', "<div class=\"post-share\"><div class=\"share-icon\"><i class=\"fa fa-share-alt\"></i></div><ul class=\"share-menu\"><li><a rel=\"nofollow noreferrer\" target=\"_blank\" href=\"https://www.blogger.com/share-post.g?blogID=", 'visibility', 'appId', "\"></div>", "<a class=\"arp-link\" href=\"", "\" itemprop=\"name\">", "!important;padding:5px;border-radius:3px\">\n        <svg viewbox=\"0 0 22 28\" style=\"fill:", '#SqIcon', 'ar_AR', "<i class=\"fa fa-check cLoaded zoom\"></i>", 'mounted', "<img class=\"notr\" title=\"", ".see-also ul", '/search/label/', '&publishedMin=', '#m-slider', ".nums span:not(.hid-num)", 'div.comments#comments', 'addClass', 'end-ad', "<img title=\"comment photo\" alt=\"comment photo\" src=\"", "<img title=\"", "\" style=\"opacity:0\" class=\"notr\"/><div class=\"overlay\"></div><div class=\"details-on-img\">", 'max-results', 'blog', 'googleusercontent.com', '&alt=json&max-results=6', '.post-contact-form', '/feeds/posts/summary/?alt=json&max-results=6', 'random', 'summary', 'tiktok', 'free-width', 'published', 'checkLicense', '<i>', '.comment', '.headline', 'resetProgress', "<span class=\"post-date\"><i class=\"fa fa-calendar-times-o\"></i>", "<div role=\"tabpanel\" class=\"notr facebook-tab\"><div class=\"fb-comments\" data-href=\"", '.aup-social', 'errorCode', 'loop', 'BackHover', '.Loading', '?max-results=', 'done', "\"/><div class=\"overlay\"></div><span class=\"label-title\">", 'iframe', 'breakpoints', 'data-pagin-src', 'wide-left', "<a target=\"_blank\" class=\"cLink disabled sq-button xl\" rel=\"nofollow noreferrer\">", 'search', "<a title=\"tweet\" target=\"blank\" href=\"", 'sq-button', 'auto', '.timeline-month', 'see-also', ".see-also li", "<p class=\"cate-snippet\">", ".Item b", '?action=getComments&widgetId=Blog1&widgetType=Blog&responseType=js&postId=', "<a class=\"timeline-title\" href=\"", 'outerHTML', 'querySelectorAll', 'unknown', 'watch?v=', 't.co', '.splide__list', 'BackColor', "\" data-width=\"100%\" data-numposts=\"5\"></div></div>", '.spc-ad', 'beginPath', 'borderRightColor', '.recent-comments', 'data-slider-src', "\" data-mega-src=\"", 'lock-', "<div role=\"article\"><a title=\"", '.comment-replies', '/posts/summary?alt=json-in-script&start-index=', "<li><a title=\"", '.aup-posts', 'curr', '.related-carousel', "<div role='feed' class='notr v-carousel splide'><div class='splide__track notr'><div class='splide__list notr'></div></div></div>", 'sided', "</p><a href=\"", 'https://twitter.com/intent/tweet?url=', '860', ".topic-author .author-about", ".ticker-content ul", "\"><span class=\"author-prof\"><i class=\"fa fa-user-circle\"></i>", '</a></h3></div></div>', 'hasClass', "<span class=\"comm-author\">", "<a target=\"_blank\" title=\"tweet\" rel=\"nofollow noreferrer\" href=\"https://twitter.com/intent/tweet?url=", "<div class=\"nums\"><span class=\"curr\">1</span></div>", '/feeds/posts/summary/?category=', '#HTML303,#SqIcon,#SqIcon>*,.tempscheme', 'forEach', 'toLocaleString', '....', '?alt=json-in-script', "<div role=\"tabpanel\" class=\"notr disqus-tab\"><div id=\"disqus_thread\"></div></div>", 'href', 'value', 'authors-page', "\"/>", '16006287JLgbBW', 'async', 'mid-ad', 'inenrHTML', '/feeds/posts/summary/?q=label:', '.sqCate', "<a rel=\"nofollow noreferrer\" href=\"", 'video-wrapper', 'Aup_Info', "<button class=\"pg-next\" title=\"", 'stylesheet', "<span class=\"next-txt\">", '802', 'name', 'data-date', "<div class=\"Middle-Ad\">", 'menu-fixed', 'version', 'nodeType', "</div><pre class=\"sq-source\">", 'autoplay', "<b class=\"blog-author-rank\">", "<div class=\"timeline-month\" data-month=\"", 'PostId', "\n        <a id=\"SqIcon\" title=\"Squeeze Template\" rel=\"nofollow noreferrer\" href=\"https://fadhiladz.blogspot.com/" target=\"_blank\" style=\"margin-", 'repeat-midad', 'strokeDasharray', "\" style=\"opacity:0\" class=\"notr\">", 'provided', 'adsbygoogle', 'none', 'host', "<button onclick='cTab(this)' role='tab' data-bar='facebook'>", "\" style=\"opacity:0\" data-src=\"", '?alt=json&max-results=6', 'blogger_logo_round', ':10px;width:30px!important;height:30px!important;background-color:', ".left-box .top", "</div><div class=\"caption\"><span class=\"label-name\">", 'offsetParent', 'blogger', 'messenger', 'pathname', 'cTab', 'parentID', "\" style=\"opacity:0\" data-slideshow-src=\"", 'innerHeight', '.cate', 'hostname', 'slideshow', 'Title', 'visible', "\" class=\"pr-but pr-but-twitter\">Twitter</a>", "<div class=\"arp-label\" id=\"l-", 'pr-but', 'str-ad', '#HTML505', '</h6>', 'premium', 'undefined', '/comments/summary?alt=json-in-script&max-results=', '.main-container', 'Snippet', 'Ticker', 'avatar', 'perMove', '*:not(.ns)', "<i class=\"fa fa-spinner fa-spin\"></i>", "<h3 class=\"cate-link\"><a href=\"", '&postID=', "</b><span class=\"arp-label-count\">", '?alt=json-in-script&max-results=', "\"  href=\"", '</span></b>', '.rand-content', 'assign', '/posts/summary?alt=json-in-script&max-results=150&start-index=', "\" title=\"author\"><i class=\"fa fa-user-circle\"></i>", 'authorPhoto', '1FtwPZc', 'toString', 'ticker', "#Pagination .pg-prev", '.entry-title', 'media$thumbnail', 'app$control', '#page-skin-1', 'parseFromString', 'support-webp', "<div class=\"img-wrap PLHolder\" onclick=\"this.querySelector('h3 a').click()\">", "<b class=\"cCount\">", 'substr', 'getContext', "\" title=\"", 'recent', 'false', "<div class=\"spc-ad\"></div>", 'role', 'opac', "<div class=\"Item notr splide__slide\"><div class=\"item-wrap\"><a title=\"", 'facebook', "<span class=\"timeline-date\">", "<h3><a title=\"", '#LinkList302', 'autoplay:playing', "<span class=\"label-title\">", '.next,.prev', 'constructor', 'rtl', 'es_LA', '6112716UHzMEV', "<a class=\"img-wrap PLHolder\" href=\"", 'cover', 'slideUp', 'https://www.blogger.com/dyn-css/authorization.css?targetBlogID=', 'pg-prev', '#l-', 'data-label', '.rlt-ad', 'commentAuthorClass', 'three-cols', 'auto-redirect', 'innerWidth', "<div class=\"timeline-item\" role=\"article\" data-month=\"", "' rel='nofollow noreferrer' target='_blank' title='Edit'>تعديل</a>", 'inReplyTo', "<a class=\"read-more\" href=\"", "\" data-pagin-src=\"", ".zooming i", '.disqus.com/embed.js', 'setAttribute', 'origin', ".categ a:nth-of-type(n+2)", 'comments-only', 'childNodes', 'en_US', "meta[name='postTitle']", 'bot-ad', '?name=', 'direction', '#comments.comments', 'appendElements', 'vslider', '<code>', "<button class=\"pg-prev\" title=\"", 'v3.3', "<a target=\"_blank\" title=\"share to Facebook\" rel=\"nofollow noreferrer\" href=\"https://www.facebook.com/sharer/sharer.php?v=4&u=", "</h1><span class=\"aup-title\"></span><p class=\"aup-about\"><p><div class=\"aup-social social\"></div><div class=\"aup-posts\" role=\"feed\"></div>", '6363091XJWXOy', '.timeline-month-name,.timeline-point', "\"><div class=\"overlay\"></div></a>", "<i class=\"clear\"></i>", 'no-items', 'end', 'topbar-fixed', "\"><div class=\"arp-label-name\"><b>", ".post-body, .post-body *:not(br)", 'splide', 'click', '?blogId=', "\" class=\"quote-fb\"><i class=\"fa fa-facebook\"></i></a>", ".slider-carousel .splide__list", "<div class=\"details\">", 'match', '.topic-related', '</u></span></div></div>', '?link=', '</div></div>', '/edit/', 'borderTopColor', 'feed', '&key=', '.blog-admin', "<div class=\"timeline-month-name hide\"><span>", 'Author_URI', 'keys', 'main', '842490luwSqP', 'data-bar', '.comment-reply', "<div class=\"item notr", "<a href=\"", "<div class=\"aup-wrapper\"><div class=\"aup-head\"><div class=\"aup-photo\" style=\"background-image:url(", 'img1.blogblog.com', "<img title=\"user avatar\" alt=\"user avatar\" data-src=\"https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiurdk3yOa6ejzSj6V_Az6QnHZ6Yjyadzs5gGXgcMIHVH562zRba02tKfl-uoFioQRY7lbSw3ODQ7mYq0_tu1wt8zSvn2NApgwSpeIpwdQ8kd5kWIvn46gnlos3IgDrlgKRwXBN6dWiWxo/s72-c-e90-rw/Unknown.png\">", '/feeds/posts/summary/-/', 'https://', "<div class=\"see-also\"><strong>", 'Date', "<div class=\"cButton\">", 'Aup_Posts_Content', 'patreon', "<a class=\"author-profile\" title=\"", 'https://www.blogger.com/blogger.g?blogID=', '(((.+)+)+)+$', 'startsWith', '</span></div>', 'mostaql', 'fadeIn', 'join', '.comments-tabs', '.go-respond', '#authors-page', 'category', '.ord', 'toLowerCase', 'removeEventListener', "<b class='author-rank'>", 'watch?v', "\" data-hcarousel-src=\"", '.slideshow-thumbs', 'valid', "<div class=\"quote-share\">", '</div></article>', 'type', "<div class=\"arp-item\">", '/posts/summary/-/', '</i>', '.aup-title', 'defer', "&target=twitter\"></a></li><li><a rel=\"nofollow noreferrer\" target=\"_blank\" href=\"https://www.blogger.com/share-post.g?blogID=", 'pageID', 'wide-right', 'blogger.displayTime', 'target', ".v-carousel .splide__list", "<circle class=\"cLoader\" r=\"70\" cy=\"100\" cx=\"100\"/>", ".left-box .bottom", '.tempscheme', 'CusWidget', 'clearRect', '</span>', "<a title=\"", "<b rel=\"nofollow noreferrer\" href=\"", 'cool-comments', 'h2,h3,h4,h5,h6', "<div class=\"slideshow-thumbnail notr splide\"><div class=\"notr splide__track\"><div class=\"notr splide__list\"></div></div><div class=\"s-progress notr\"></div><div class=\"splide__autoplay hide\"><button class=\"splide__play\"></button><button class=\"splide__pause\"></button></div></div>", ".nums span.hid-num", 'nums', '.post-body', 'innerText', 'be/', 'fromCharCode', "<div class='recent-comments'></div>", "<div class=\"notr splide__track\"><div class=\"notr splide__list\"></div></div>", "\"/><div class=\"overlay\"></div><div class=\"details-on-img\">", 'Slider', 'https://script.google.com/macros/s/AKfycbzTAnbEpIJ9WW1JvLF9FZXUbC83NsEWR6MR4wb1NV-k4Q761gs/exec', '/posts/summary?alt=json-in-script&max-results=', '</div>', 'onscroll', 'data-vcarousel-src', 'hide', '.scroll-top', 'MOVING', '.nums', "<span class=\"blog-author-avatar\" style=\"background-image:url(", 'onClick', "</span><h3><a href=\"", 'zIndex', 'is-active', 'pgn-ad', 'onfocus', "\" class=\"img-wrap PLHolder notr splide__slide\">", '_HandleControllerResult', 'previousElementSibling', ".comments-list > ul", " profile\" href=\"", 'oneScroll', "<div class='rand-content'></div>", '__wavt', "<a class=\"ribble\" href=\"", 'comment-reply', '.timeline-item', "<h3 class=\"post-title cate-link\"><a class=\"entry-title\" href=\"", 'head', 'blogId', '.top-ad', '#comments-respond', 'split', "<div class=\"blog-authors\"></div>", '&parentID=', '.impo', 'nextprev', 'rel', 'entry', 'body', 'background:-webkit-linear-gradient(45deg,#d24949,#9e44c9);background:-moz-linear-gradient(45deg,#d24949,#9e44c9);background:-o-linear-gradient(45deg,#d24949,#9e44c9);background:linear-gradient(45deg,#d24949,#9e44c9);background-attachment:fixed', "\" class=\"comm-author\" target=\"_blank\" rel=\"nofollow noreferrer\">", 'ceil', 'nextElementSibling', 'max-ticker', 'concat', 'indexOf', 'parentElement', '/search?max-results=', 'https://fadhiladz.blogspot.com/', 'rgba(0,0,0,0.3)', 'textAlign', 'fadeOut', "blog-admin ", 'zoom', 'flickity-enabled', 'cate-', 'disabled', '/sdk.js', "\"></a></svg></a>", 'author', '.modal-body', 'width', 'parse', '?alt=json-in-script&max-results=150&start-index=', "meta[name='postPoster']", 'arrows', 'facebook.com', '.acc-head', "<div class=\"modal-content notr\"><div class=\"modal-head\"><div class=\"modal-title\"></div><span class=\"modal-close fa fa-times\"></i></div><div class=\"modal-body\"></div></div></div></div>", 'carousel', '.widget', 'move', '.splide', 'share-open', ".comments-list > ul > li.comment:last-of-type", ".post-body blockquote:not(.twitter-tweet)", 'rdct-exclude', 'map', 'disqus-ID', "<div class=\"redirect-modal notr\"><div class=\"modal-overlay\">", 'cmt-ad', "&target=facebook\"></a></li><li><a rel=\"nofollow noreferrer\" target=\"_blank\" href=\"https://www.blogger.com/share-post.g?blogID=", " Facebook</button>", 'gd$extendedProperty', 'uri', 'top-ad', "<div class='notr blogger-tab' role='tabpanel'></div>", 'two-cols', '/posts/summary?alt=json-in-script', '#FFF', '/posts/summary/?q=label:', 'max-rel', '&referrer=facebook', " </span>", 'anchorName', 'strokeStyle', 'StartSide', '.pgn-ad', "</a></h3><div class=\"details\">", "<div class=\"Item notr\" role=\"article\">", "<a class=\"author-prof\" rel=\"nofollow noreferrer\" href=\"", '</a></h3>', 'true', '.premium', '.cLink', 'arrow', 'ttb', ".intro .HTML", " avatar\" data-src=\"", "<span class=\"arp-cate\">", 'closest', "<b class=\"blog-author-count\">", '.post-pages', 'title', '|label:', 'prev', '/b/blog-preview', '.cLoader', "\"><img alt=\"", '/img/', 'disqus', "<li><a href=\"", 'post', " avatar\" alt=\"", 'rank', '.post-outer', "<a class=\"fa fa-", 'from', '/s40-c/', "header .color-wrap", 'reset', 'old-blogger', ")\"></div></div><h1 class=\"aup-name\">", 'pagination', 'onblur', 'template', 'found', '#editor/target=', 'search/label/', 'each', "<div class=\"blog-author-card\" data-blog-author=\"", 'redirect-inside', "\" data-vCarousel-src=\"", 'deleteUrl', 'stickysides', "<a href='", 'opacity', "':.+?,", '#Pagination', 'substring', 'show-nextprev', '</strong><ul></ul></div>', 'shadowBlur', '.mega-wrap', 'data-src', '.end-ad', 'max-intro', "<div class=\"code-sn\">", 'content', '.str-ad', 'rlt-ad', 'http://', 'https://www.facebook.com/sharer.php?u=', '<p>', '#menu-bar', "&target=pinterest\"></a></li></ul></div>", '.modal-title', '#blogger-components', '-tab', 'about', 'getAttribute', 'pg-next', '.blogger-tab', 'smooth', "\" data-slider-src=\"", '...</p>', ".avatar-image-container img", 'children', 'link', "<div class=\"overlay\"></div>", 'FB-app-ID', 'class', '&xssi_token=', "<div class=\"details-on-img\">", '1268940utKNGQ', 'behavior', 'text/html', 'redirect-page', '.Item', 'round', "#comments-respond noscript", 'SCRIPT', '304XwQwgk', '.MegaItem', ".index-posts .post-outer:nth-of-type(", '<b>', '.splide__play', '/feeds/posts/summary?alt=json&max-results=150&start-index=', '5rjTGfC', "</span><h3><a title=\"", 'length', ".related-carousel .splide__list", "\" alt=\"", "<span class=\"label-name\">", '.topic-nav', ".post-body a[href]:not([href^=\"https://twitter.com/\"])", 'video', "\" class=\"post-outer\"><div class=\"post gtd\">", 'fontSize', " <u>", "<div class=\"article-ad pgn-ad\"></div>", 'repeat-indexad', '.slider-carousel', 'thumbUrl', '&max-results=', 'stringify', 'https://fadhiladz.blogspot.com/', '</svg>', "<span class=\"prem-desc\">", "\" href=\"", "<img alt=\"", 'discord', '/posts/summary', 'apply', "\"><svg><use href=\"#ic-", 'slideDown', ".post-body *", "[data-blog-author=\"", 'referrer', '&start-index=', 'one-col', 'getItem', 'stroke-dashoffset', '.m-slider', '<span>', 'single-intro', "<div role='feed' class='notr slider-carousel splide'><div class='splide__track notr'><div class='splide__list notr'></div></div></div>", '.no-items', 'block', "<a title=\"share to Facebook\" target=\"blank\" href=\"", 'data-slideshow-src', 'delete', 'FillColor', 'https://www.blogger.com/feeds/', '.splide__pause', 'data-overflow', 'data-mega-src', '.sided-sections', "\"></a><h3><a href=\"", '_blank', 'replaceState', '#FFFFFF', 'alt', "\"></a>", "!important;width:100%!important;height:100%!important;transition:0s\"><path d=\"M1.552 18.849c0.913 0 1.757 0 2.601 0 0.080 0.468 0.126 0.924 0.24 1.369 0.65 2.453 2.042 4.29 4.518 5.077 4.039 1.278 8.363-1.654 8.74-5.865 0.274-2.989-1.267-5.637-3.959-6.835-0.776-0.342-1.609-0.365-2.442-0.388-1.004-0.023-2.008 0.011-3.012-0.023-0.73-0.023-1.472-0.080-2.191-0.217-1.472-0.274-2.613-1.095-3.389-2.362-1.107-1.803-1.346-3.731-0.662-5.728 0.73-2.134 2.316-3.309 4.541-3.628 2.408-0.354 4.815-0.251 7.234-0.091 2.282 0.148 4.553 0.297 6.835 0.205 0.513-0.023 1.027-0.068 1.643-0.103-0.114 0.183-0.171 0.354-0.285 0.434-0.411 0.319-0.81 0.65-1.255 0.901-1.472 0.833-3.058 1.312-4.747 1.312-1.871 0-3.754-0.091-5.625-0.126-1.267-0.023-2.533-0.011-3.765 0.342-1.027 0.297-1.86 0.822-2.214 1.894-0.251 0.787-0.251 1.597-0.011 2.396 0.24 0.776 0.787 1.312 1.552 1.529 0.685 0.194 1.392 0.319 2.099 0.377 1.267 0.091 2.544 0.057 3.822 0.137 4.267 0.285 7.839 3.663 8.386 7.907 0.331 2.544-0.126 4.918-1.712 6.994-1.267 1.643-2.944 2.681-4.929 3.229-2.248 0.628-4.484 0.559-6.641-0.354-3.024-1.267-4.678-3.617-5.192-6.812-0.091-0.513-0.126-1.027-0.183-1.575z\"></path><path d=\"M0.034 13.817c0.103-0.011 0.205-0.034 0.308-0.034 1.974 0.023 3.959 0.080 5.933 0.080 1.848 0 3.685-0.023 5.522 0.205 0.183 0.023 0.365 0.057 0.548 0.114 1.757 0.536 3.32 2.613 3.366 4.461 0.046 2.328-1.518 4.222-3.857 4.689-0.833 0.171-1.677 0.171-2.487-0.080-1.814-0.559-2.784-1.848-3.092-3.685-0.023-0.148-0.046-0.308-0.057-0.468-0.011-0.068 0-0.148 0-0.262 0.399 0 0.81 0.034 1.198-0.011 0.73-0.091 1.255 0.080 1.609 0.81 0.194 0.399 0.593 0.719 0.936 1.015 0.456 0.388 1.004 0.411 1.552 0.205 1.038-0.388 1.666-1.529 1.403-2.613-0.114-0.491-0.456-0.799-0.89-1.027-0.73-0.388-1.529-0.536-2.328-0.605-0.901-0.080-1.803-0.126-2.704-0.126-2.020 0-3.868-0.525-5.557-1.632-0.479-0.308-0.947-0.639-1.415-0.947 0-0.034 0-0.068 0.011-0.091z\"></path><path d=\"M17.446 4.963c-0.879 0.833-1.928 1.46-3.092 1.905-2.168 0.822-4.404 0.947-6.663 0.525-0.456-0.080-0.879-0.331-1.301-0.548-0.114-0.057-0.217-0.251-0.228-0.399-0.091-0.81 0.342-1.426 1.141-1.643 1.050-0.285 2.111-0.251 3.183-0.16 1.483 0.126 2.978 0.274 4.461 0.354 0.833 0.046 1.666-0.023 2.499-0.034z\"></path></svg></a>", "\"] .blog-author-social", '.widget-content', 'parentsUntil', 'fill', ".topic-author .clear-left", 'timestamp', '</div></div></div>', "<div class=\"slideshow-thumbs\"></div>", "<i class=\"tempscheme\"/>", 'FillHover', 'toUpperCase', '.bot-ad', "\" class=\"img-wrap PLHolder\"><img style=\"opacity:0\" class=\"rel-img notr\" data-rel-src=\"", 'blank', '</span></a>', '.topic-author', 'toggle-comments', 'XFBML', 'fade', 'right', 'scrollY', 'div', "#m-slider .splide__list", 'related-posts', 'trim', "\" style=\"opacity:0\" class=\"notr\" data-src=\"", '/js/cookienotice.js', 'fa-plus', '&text=', 'getComputedStyle', 'prototype', 'appendChild', 'before', 'dispatchEvent', '.section', '_GetAllData', '</b>', 'replace', '#Blog1', '.comments-bar', '</span></div><p>', 'inline', 'filter', "</div><h3><a title=\"", '<->', '#comment-editor', 'blockquote', '</p>', 'blogUrl', "'s avatar", 'floor', 'removeClass', 'rdct-time', 'ImgUrl', '</a></h3></div>', "<div role=\"article\" class=\"notr item splide__slide\"><div class=\"img-wrap PLHolder\"><img title=\"", 'scroll', '.blog-authors', "<div class=\"mega-carousel splide notr\"><div class=\"splide__track notr\"><div class=\"splide__list notr\">", 'HTML', 'authorUrl', '</ul></nav>', 'web.archive.org', '.v-carousel', 'string', 'display', 'push', 'embed/', 'page', 'links', 'postID', '1160', "\" class=\"img-wrap PLHolder\"><img title=\"", ".pg-prev, .pg-next", '&referrer=twitter', 'onclick', '.noimg', 'arc', 'Aup_avatar', ".comments-show button", "#m-slider .item", "<div class=\"blog-author-social\"></div>", 'comment-sys', "console.group(\"%cSqueeze Template\", \"font-weight:bold;color:#d24949;font-family:Tahoma;font-size:18px;\");console.log(\"» Homepage      : https://fadhiladz.blogspot.com/");console.log(\"» Designed by   : Ahmad Saleh\");console.log(\"» Programmed by : Muhammad Saleh\");console.log(\"» Version       : 2.3.1\");console.groupEnd()", 'tight-width', 'button', '992', 'thumbs', 'script', '#redirect-page', '&release=v2&callback=checkLicense', 'FullDate', '.item', 'comments', '//connect.facebook.net/', 'mount', 'height', '.com-date', '.slideshow-thumbnail', "\" style=\"opacity:0\" data-carousel-src=\"", 'onmouseenter', 'parentNode', 'url', 'src', " splide__slide", "#Pagination .pg-next", 'alternate', 'top', 'tradent', '303120gqjZGn', 'long', 'impo', 'get', 'khamsat', '</a></h2>', '[data-label]', '.mega-carousel', 'a[href]', 'spc-ad', '...', ".post-body ins", 'STATES', "<div class=\"caption\">", "<div class=\"splide__slide mega-post notr\">", "<b class=\"timeline-point\"></b>", 'month', " Disqus</button>", '</a></li>', 'includes', 'getElementsByTagName', "<h2 class=\"post-title\"><a class=\"entry-title\" href=\"", "<button onclick='cTab(this)' role='tab' tabindex='0' data-bar='blogger'>", 'shadowColor', 'bp.blogspot.com', 'Category', 'https://www.youtube.com/embed/', '640', 'createElement', 'left', 'after', 'stroke', 'offset', 'offsetWidth', '-cc', "<div class='temp-error'><b>WIDGET ERROR</b><span>No posts found OR Blog feeds are disabled</span></div>", "#Pagination .nums", 'prepend', 'fa-minus', '.cmt-ad', " .comment-replies ul", "pre *,ins *,iframe *, blockquote:not(.twitter-tweet) *,ul *,ol *,.separator *,br,table, table *,.ContactForm, .ContactForm *,.premium, .premium *,h2,h3,h4,h5,h2 *, h3 *, h4 *, h5 *, .Middle-Ad, .Middle-Ad *", 'pre.sq-code', 'querySelector', ".ticker-content nav", 'init', '.redirect-modal', 'https://Squeezetemplate.github.io/assets/splidejs@2.4.21.min.js', 'translate.googleusercontent.com', 'twitter', "<span class=\"arp-date\">", 'fixed', 'siblings', 'show-related', 'nodeName', "\"></iframe>", '&quote=', "\" class=\"img-wrap PLHolder\">", 'slider', ".comments-bar button", '.index-posts', 'no-wide', ".separator a:not([href*=\"bp.blogspot.com\"]):not([href*=\"googleusercontent\"])", "<b class=\"blog-author-name\">", 'google-play', 'addEventListener', 'open', 'canvas', "\" class=\"fa fa-", "<div class=\"Item notr", 'borderLeftColor', 'location', 'removeAttribute', '</a></h3></div></div></div>', "\"><span>", 'Link', "<button onclick='cTab(this)' role='tab' data-bar='disqus'>", 'modal-close', '#ContactForm93', 'find', '1100', "<circle class=\"cPath\" r=\"70\" cy=\"100\" cx=\"100\"/>", '.s-progress', ".post-body a", ".topic-author .social", '<br>', '.separator', 'data-rel-src', '100%', '#loadmore', 'share-icon', '#HTML303', "\" class=\"pr-but pr-but-facebook\">Facebook</a>", 'Aup_Name', 'offsetHeight', 'blogger-api', 'float', '/feeds', '.curr', 'append', 'style', '</code>', 'sticky-nav', 'flat', "\" role=\"article\">", '.aup-about', 'https://blogger.com/blog/', 'setItem', 'gd$image', 'data-len', "<iframe title=\"youtube video\" src=\"", "<b class=\"timeline-point hide\"></b>", 'lazy-load', "<img class=\"arp-thumb\" src=\"", '?alt=json&max-results=10', 'innerHTML', "\"/></svg></a>"];
  I = function () {
    return Wq;
  };
  return I();
...
(function () {
  ...
  let p = new Array(0x1a).fill(0x1).map((KR, Kj) => String.fromCharCode(0x61 + Kj));
  let Q = new Array(0x1a).fill(0x1).map((KR, Kj) => String.fromCharCode(0x41 + Kj));
  let J = new RegExp("'" + p[0x1] + p[0xb] + p[0xe] + p[0x6] + Q[0x8] + p[0x3] + "':.+?,");
  let i = _$("#blogger-components").innerHTML.match(J)[0x0].replace(/[^0-9]/g, '');
  let g = false;
  let L = window.location.href;
  let x = typeof LicenseKey != "undefined" ? LicenseKey : false;
  let X = SqCmz["comment-sys"] || "blogger";
  let d = SqCmz["FB-app-ID"] || '';
  let W = SqCmz["disqus-ID"] || '';
  let B = SqCmz["max-results"] || 0xa;
  let e = SqCmz["max-intro"] || 0x7;
  let t = SqCmz["max-ticker"] || 0x7;
  let a = SqCmz["max-rel"] || 0xa;
  let O = SqCmz["rdct-time"] || 0xa;
  let y = SqCmz["rdct-exclude"] || '';
  let Z = SqCmz["auto-redirect"] !== undefined ? SqCmz["auto-redirect"] : false;
  let k = SqCmz["see-also"] !== undefined ? SqCmz["see-also"] : true;
  let D = SqCmz["cool-comments"] !== undefined ? SqCmz["cool-comments"] : true;
  let q = SqCmz["show-related"] !== undefined ? SqCmz["related-posts"] : true;
  let w = SqCmz["show-nextprev"] !== undefined ? SqCmz.nextprev : true;
  let R = SqCmz["lazy-load"] !== undefined ? SqCmz["lazy-load"] : true;
  let j = SqCmz["sticky-nav"] !== undefined ? SqCmz["sticky-nav"] : true;
  let z = SqCmz["menu-fixed"] !== undefined ? SqCmz["menu-fixed"] : false;
  let c = SqCmz["topbar-fixed"] !== undefined ? SqCmz["topbar-fixed"] : false;
  let v = SqCmz["repeat-midad"] !== undefined ? SqCmz["repeat-midad"] : false;
  let s = SqCmz["repeat-indexad"] !== undefined ? SqCmz["repeat-indexad"] : 0x0;
  let b = SqCmz["support-webp"] !== undefined ? SqCmz["support-webp"] : false;
  let S = SqCmz["blogger-api"] !== undefined ? SqCmz["blogger-api"] : false;
  let m = SqCmz["old-blogger"] !== undefined ? SqCmz["old-blogger"] : false;
  let N = SqCmz["redirect-inside"] !== undefined ? SqCmz["redirect-inside"] : false;
  let G = SqCmz["single-intro"] !== undefined ? SqCmz["single-intro"] : false;
  let f = SqCmz["toggle-comments"] !== undefined ? SqCmz["toggle-comments"] : false;
  let F = SqCmz["redirect-page"];
  let V = SqCmz["authors-page"];
  let r = ["khamsat", "mostaql", "tradent", "google-play", "messenger", "blogger", "discord", "tiktok", "patreon"];
  let h = {};
  let l = String.fromCharCode(0x68, 0x74, 0x74, 0x70, 0x73, 0x3a, 0x2f, 0x2f, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6d, 0x61, 0x63, 0x72, 0x6f, 0x73, 0x2f, 0x73, 0x2f, 0x41, 0x4b, 0x66, 0x79, 0x63, 0x62, 0x77, 0x72, 0x31, 0x4f, 0x42, 0x42, 0x75, 0x62, 0x75, 0x6c, 0x56, 0x49, 0x39, 0x61, 0x4e, 0x66, 0x41, 0x6c, 0x75, 0x76, 0x74, 0x6f, 0x6d, 0x4b, 0x73, 0x41, 0x36, 0x45, 0x79, 0x37, 0x67, 0x44, 0x33, 0x30, 0x54, 0x36, 0x46, 0x37, 0x66, 0x79, 0x51, 0x44, 0x4d, 0x43, 0x59, 0x67, 0x64, 0x55, 0x75, 0x42, 0x2f, 0x65, 0x78, 0x65, 0x63);
  let o = false;
  let n = false;
  let E = false;
  let T = false;
  ...
  if (typeof _bl != "undefined") {
    _bl.each(function (KR, Kj) {
      h[KR.split(':')[0x0]] = parseInt(KR.split(':')[0x1]);
    });
  } else {
    h = {};
  }
  PostCount = typeof PostCount != "undefined" ? PostCount : 0x0;
  feed_count = Math.ceil(PostCount / 0x96);
  ...
  function K0() {
    ...
    if (z) {
      const KR = _$("#LinkList302").offset().top + 0x3c;
      window.addEventListener("scroll", function () {
  ...
  function K1() {
    ...
    function KR() {
      ...
      var Kz = Kj.match(/http.+?widgets\.js/)[0x0];
      ...
      if (Ks != null) {
        $getScript("/js/cookienotice.js", function () {
          Ks[0x0].replace(/(\<script\>|\<\/script\>)/g, '').match(/(\(window|window).*/g).each(function (KS, Km) {
            Kb += KS;
          });
          eval(Kb);
        });
  ...
  function K4(KR) {
    ...
    Kj.Author = KR.author[0x0].name !== undefined ? KR.author[0x0].name.$t : "unknown";
    Kj.Author_URI = KR.author[0x0].uri !== undefined ? KR.author[0x0].uri.$t : '#';
    Kj.Category = KR.category !== undefined ? KR.category[0x0].term : "....";
    ...
    Kj.Date = Kj.FullDate.substr(0x8, 0x2) + " " + K3(Kj.FullDate) + " " + Kj.FullDate.substr(0x0, 0x4);
    Kj.PostId = KR.id.$t.replace(/.+\-/g, '');
    return Kj;
  }
  function K6(KR) {
    if (!n) {
      $getScript("https://Squeezetemplate.github.io/assets/splidejs@2.4.21.min.js", function () {
        n = true;
        KR();
      });
    } else {
  ...
  function K7() {
    ...
    Kv.innerHTML = "console.group(\"%cSqueeze Template\", \"font-weight:bold;color:#d24949;font-family:Tahoma;font-size:18px;\");console.log(\"» Homepage      : https://fadhiladz.blogspot.com/");console.log(\"» Designed by   : Ahmad Saleh\");console.log(\"» Programmed by : Muhammad Saleh\");console.log(\"» Version       : 2.3.1\");console.groupEnd()";
  ...
  const K9 = function (KR) {
    ...
    if (window.location.href.indexOf("/b/blog-preview") == -0x1) {
  ...
  let KK = setInterval(function () {
    ...
    if (KR.indexOf("https://fadhiladz.blogspot.com/") == -0x1) {
      K9(0x2);
    }
    if (_$("#SqIcon").href !== "https://fadhiladz.blogspot.com/") {
      K9(0x3);
    }
    _$(".impo").each(function (Kj) {
      var Kz = window.getComputedStyle(Kj);
      if (Kz.visibility != "visible" || Kz.opacity < 0x1 || Kz.zIndex < 0x1 && Kj.zIndex != "auto" && Kj.nodeName != "HTML" || Kz.display.indexOf("inline") == -0x1 && Kz.display.indexOf("block") == -0x1) {
        K9(0x3);
      }
    });
  }, 0x3e8);
              ...
              if (Kv.feed.entry) {
                ...
                Kv.feed.entry.each(function (Kb, KS) {
                  if (!Kb.app$control) {
                    ...
                    Ks += "<a class=\"img-wrap PLHolder\" href=\"" + Km.Link + "\"><img alt=\"" + Km.Title + "\" title=\"" + Km.Title + "\" data-mega-src=\"" + resizeImg(Km.ImgUrl, 0xfa, 0x96) + "\"><div class=\"overlay\"></div></a>";
  ...
  function KI() {
    ...
    function Kz(Kc) {
      ...
      var KF;
      if ((Kb === "random" || Kb === "recent" || Kb in h) && PostCount > 0x0 && FeedEnabled && !isPrivate) {
        KU();
      } else {
      ...
      function KU() {
        ...
        KF += "&max-results=" + (Ks == "Slider" && G ? 0x3 : KN);
        if (isStorage) {
        ...
        function Kr(Kh) {
            ...
            if (!Ku.app$control) {
              ...
              if (Kc.querySelector("div").hasClass("main-slider")) {
                ...
                if (KY === 0x0) {
                  ...
                  Km += "<p>" + KA.Snippet.substring(0x0, 0xb4) + "...</p>";
                  Km += "</div></div></div>";
                }
              }
            }
          ...
          if (Ks === "Ticker") {
            ...
            var KE = Kn;
            var KT = 0x0;
            if (Ko.children.length >= 0x1) {
              var KH = 0x0;
              Ko.children.each(function (KA) {
                KH += KA.offsetWidth;
              });
              KT = KH + Ko.children.length * 0x28 - 0x28;
  ...
  function KM() {
    ...
    function Kj(Kz) {
      ...
      if ((Ks === "random" || Ks === "recent" || Ks === "comments" || Ks in h) && PostCount > 0x0 && FeedEnabled && !isPrivate) {
        Kf();
      } else {
      ...
      function Kf() {
        if (Ks === "random" || Ks === "recent") {
          Kb = PostCount - Kb > 0x0 ? Kb : PostCount;
            ...
            KU.feed.entry.each(function (Kr, Kh) {
              if (!Kr.app$control) {
                ...
                if (Ks === "comments" && KU.feed.entry[Kh].link.filter(function (KA) {
                  ...
                  var KP = decodeURIComponent(Kr.author[0x0].name.$t);
                  var Ku = Kr.author[0x0].uri !== undefined ? KU.feed.entry[Kh].author[0x0].uri.$t : null;
                  var KY = Ku ? "<a href=\"" + Ku + "\" class=\"comm-author\" target=\"_blank\" rel=\"nofollow noreferrer\">" + KP + "</a>" : "<span class=\"comm-author\">" + KP + "</span>";
                  CAu_img = Kr.author[0x0].gd$image.src;
          ...
          if (KS === "vslider") {
            K6(function () {
              new Splide(Kc.querySelector(".v-carousel"), {
                'direction': "ttb",
                'height': Kc.querySelector(".item").offsetHeight * 0x3,
                'gap': 0xf,
                'pagination': false,
                'autoplay': true,
                'perPage': 0x3,
  ...
  function Kp() {
    ...
    if (KR === 0x0 || !FeedEnabled) {
      ...
      if (L.indexOf("/search/label/") != -0x1) {
        Kj = location.pathname.split('/')[0x3];
      ...
      for (Kc = 0x2; Kc <= Math.ceil(Kv / KR); Kc++) {
        _$("#Pagination .nums").append("<span>" + Kc + "</span>");
      }
      function Kb() {
        if (Math.ceil(Kv / KR) > _$(".nums").offsetWidth / 0x27) {
          if (_$("#Pagination .pg-prev").length == 0x0) {
            _$("#Pagination").prepend("<button class=\"pg-prev\" title=\"" + trans[0x2] + "\"></button>");
            _$("#Pagination").append("<button class=\"pg-next\" title=\"" + trans[0x3] + "\"></button>");
          }
        } else {
    ...
    _$(".pg-prev, .pg-next").onClick(function (KS) {
      if (KS.target && KS.target.hasClass("pg-next")) {
        ...
        if (Km.textContent != Math.ceil(Kv / KR) - Math.floor(_$(".nums").offsetWidth / 0x27) + 0x1) {
          Km.addClass("hid-num");
        }
      }
      if (KS.target && KS.target.hasClass("pg-prev")) {
        ...
        if (KN.length > 0x0) {
          KN[KN.length - 0x1].removeAttribute("class");
        }
      }
    });
    _$("#Pagination").onclick = function (KS) {
      if (KS.target && KS.target.parentElement.hasClass("nums") && !KS.target.hasClass("curr")) {
        ...
        if (FeedEnabled && !isPrivate) {
          ...
          var KN = Km.textContent * KR - KR + 0x1;
          $getJSONP(Kz + "?alt=json-in-script&max-results=" + KR + "&start-index=" + KN, function (KG) {
            ...
            KG.feed.entry.each(function (KU, Kr) {
              if (!KU.app$control) {
                var Kh = K4(KU);
                Kh.Snippet = Kh.Snippet.substr(0x0, snippetLength) + "...";
  ...
  function KJ(KR) {
    var Kj = KR.getElementsByTagName("canvas")[0x0];
    var Kz = Kj.width;
    var Kc = Kj.height;
    ...
    var Kf = 0x0;
    (function KF(KV) {
      Kv.clearRect(0x0, 0x0, Kz, Kc);
      Kv.beginPath();
      Kv.arc(Ks, Kb, 0x14, 0x0, KV, false);
      Kv.stroke();
      Kf++;
      if (Kf < 101) {
  ...
  function Ki() {
    _$(".sided-sections").each(function (KR) {
      ...
      var Kz;
      if (KR.querySelectorAll(".section").length === 0x3) {
        if (Kj.length === 0x0) {
          Kz = "three-cols";
        } else {
          if (Kj.length === 0x1) {
            ...
            if (KR.querySelector(".section").hasClass("no-items")) {
              KR.querySelectorAll(".section")[0x0].addClass("wide-right");
            } else {
              if (KR.querySelectorAll(".section")[0x1].hasClass("no-items")) {
                KR.addClass("no-wide");
              } else if (KR.querySelectorAll(".section")[0x2].hasClass("no-items")) {
                KR.querySelectorAll(".section")[0x0].addClass("wide-left");
              }
            }
          } else {
            if (Kj.length === 0x2) {
              Kz = "one-col";
            } else if (Kj.length === 0x3) {
              Kz = "hide";
            }
          }
        }
      } else {
        if (KR.querySelectorAll(".section").length === 0x2) {
          if (Kj.length === 0x0) {
            Kz = "two-cols";
            KR.addClass("no-wide");
          } else {
  ...
  function Kg() {
    ...
    function Kj(Kz) {
      ...
      if ((KG === "random" || KG === "recent" || KG in h) && PostCount > 0x0 && FeedEnabled && !isPrivate) {
        Kh();
      } else {
      ...
      function Kh() {
        if (KG === "random" || KG === "recent") {
          KF = PostCount - KF > 0x0 ? KF : PostCount;
        ...
        function Ko(Kn) {
          ...
          Kn.feed.entry.each(function (KT, KH) {
            ...
            if (!KT.app$control) {
              var Ku = K4(KT);
              Ku.Snippet = Ku.Snippet.substr(0x0, snippetLength) + "...";
              ...
              switch (Kf) {
                case "slideshow":
                  KP += "<div class=\"Item notr " + (KH == 0x0 ? "is-active" : '') + "\" role=\"article\">";
          ...
          if (Kc.querySelectorAll(".Item b").length > 0x0) {
  ...
  function KL() {
    ...
    if (AllowComments) {
      ...
      if (f) {
        ...
        Kc.innerText = trans[0x28];
        Kc.onclick = Kv;
        KR.before(Kc);
      } else {
        window.addEventListener("scroll", function () {
          if (window.scrollY > KR.offset().top - 0x1f4 || !R) {
            Kv();
          }
        });
      }
    ...
    function Kv() {
      ...
      Ks.each(function (Km) {
        if (Km === "blogger") {
          _$(".comments-bar").append("<button onclick='cTab(this)' role='tab' tabindex='0' data-bar='blogger'>" + trans[0x10] + " Blogger</button>");
          _$(".comments-tabs").append("<div class='notr blogger-tab' role='tabpanel'></div>");
          _$(".blogger-tab").append(_$("div.comments#comments"));
        }
        if (Km === "facebook") {
          _$(".comments-bar").append("<button onclick='cTab(this)' role='tab' data-bar='facebook'>" + trans[0x10] + " Facebook</button>");
        ...
        if (Km === "disqus") {
          _$(".comments-bar").append("<button onclick='cTab(this)' role='tab' data-bar='disqus'>" + trans[0x10] + " Disqus</button>");
          _$(".comments-tabs").append("<div role=\"tabpanel\" class=\"notr disqus-tab\"><div id=\"disqus_thread\"></div></div>");
        }
      });
      if (X.indexOf("blogger") == -0x1) {
        _$("#comments.comments").remove();
      }
      document.querySelectorAll(".comments-bar button")[0x0].dispatchEvent(new Event("click"));
      if (AllowNew) {
      ...
      function Kb(Km) {
        ...
        Km.innerHTML = Km.innerHTML.replace(/(https:\/\/)(www.youtube|youtube|youtu)(.com\/|.be\/).+?(\s|<br.*?>|$)/g, function (KN) {
          if (KN.indexOf("watch?v") !== -0x1) {
            KN = KN.replace("watch?v=", "embed/");
          }
          if (KN.indexOf("youtu.be") !== -0x1) {
            KN = "https://www.youtube.com/embed/" + KN.split("be/")[0x1];
          }
          if (KN.indexOf("&amp;") !== -0x1) {
            KN = KN.replace("&amp;", '?');
          }
      ...
      function KS(Km) {
        ...
        Km.forEach(function (KN, KG) {
          ...
          var KU = KN.authorPhoto ? KN.authorPhoto.thumbUrl : KN.authorAvatarSrc.indexOf("blank") != -0x1 ? AltAuthor : KN.authorAvatarSrc;
          KU = KN.inReplyTo ? resizeImg(KU, 0x28, 0x28) : resizeImg(KU, 0x48, 0x48);
      ...
      if (AllowNew) {
        _$(".go-respond").addEventListener("click", function () {
          if (_$("#comment-editor").src.indexOf("parentID") !== -0x1) {
      ...
      _$("#loadmore").onClick(function () {
        ...
        $getScript(location.pathname + "?action=getComments&widgetId=Blog1&widgetType=Blog&responseType=js&postId=" + itemId + "&publishedMin=" + _$(".com-date")[_$(".com-date").length - 0x1].getAttribute("data-date") + "&xssi_token=" + window.__wavt, function () {});
      });
    }
    window.cTab = function (Ks) {
      ...
      _$(".comments-tabs").children.each(function (KG) {
        KG.slideUp(0x1f4, function () {
          _$('.' + Kb + "-tab").slideDown(0x1f4);
        });
      });
      _$(".avatar-image-container img").each(function (KG) {
        if (KG.src.indexOf("blogger_logo_round") != -0x1) {
      ...
      if (Kb == "facebook" && !H) {
        ...
        switch (BlogLang) {
          ...
          case 'en':
            ...
            break;
          default:
            Km = BlogLang.indexOf('_') != -0x1 ? BlogLang : BlogLang.toLowerCase() + '_' + BlogLang.toUpperCase();
        }
  ...
  function Kx() {
    ...
    if (V && isPost) {
      _$(".topic-author").append("<a class=\"author-profile\" title=\"" + AuthorName + " profile\" href=\"" + V + "?name=" + encodeURI(AuthorName) + "\">" + trans[0x13] + "</a>");
    }
    if (F) {
      _$(".post-body a[href]:not([href^=\"https://twitter.com/\"])").each(function (KR) {
        var Kj = KR.href;
        var Kz = y ? y.split(',').filter(function (Ks) {
          return Kj.indexOf(Ks) != -0x1;
        }) : [];
        var Kc = new URL(Kj);
        var Kv = new URL(location);
        if (Kc.hostname != Kv.hostname && !Kc.hostname.includes("bp.blogspot.com") && !Kc.hostname.includes("googleusercontent.com") && Kz.length == 0x0 && !KR.closest(".premium")) {
          if (N) {
  ...
  function KX() {
    ...
    _$("pre.sq-code").each(function (KF) {
      var KV = KF.innerHTML.indexOf("\n") != -0x1 ? KF.innerHTML.split("\n") : KF.innerHTML.split("<br>");
      var KU = new String();
      var Kr = new String();
      var Kh;
      for (Kh = 0x0; Kh < KV.length; Kh++) {
    ...
    var Kj;
    if (L.indexOf('?') !== -0x1 && L.split('&') !== -0x1 && localStorage.getItem("lock-" + itemId) === "true") {
      var Kz = L.split('?')[0x1].split('&');
      var Kc = Kz.filter(function (KF) {
        return KF.split('=')[0x0] === 'id';
      })[0x0];
      var Kv = Kz.filter(function (KF) {
        return KF.split('=')[0x0] === "referrer";
      })[0x0];
      var Ks = Kv !== undefined ? Kv.split('=')[0x1] : undefined;
      var Kb = Kc !== undefined ? Kc.split('=')[0x1] : undefined;
      var KS = document.referrer;
      if (Kb == itemId && (Ks == "facebook" || Ks == "twitter") && (KS.indexOf("facebook.com") !== -0x1 || KS.indexOf("t.co") !== -0x1)) {
    ...
    if (Km.found()) {
      if (Kj === "true") {
        _$(".post-body .premium").each(function (KF) {
          ...
          KV = "<h6 class=\"prm-title\">" + trans[0x11] + "</h6>";
          KV += "<span class=\"prem-desc\">" + trans[0x12] + "</span>";
    ...
    var KG = KN.filter(KF => KF.nodeType === 0x8 && KF.textContent.startsWith("video") && KF.textContent.includes("iframe"));
    KG.forEach(function (KF) {
      var KV = KF.previousElementSibling || KF.parentNode;
      window.addEventListener("scroll", KU);
      function KU() {
        if (window.scrollY >= KV.offset().top - 0x1f4) {
          Kf(KF);
  ...
  function Kd() {
    if (_$("#authors-page").found()) {
      ...
      if (KR.get("name")) {
        ...
        Aup_avatar = resizeImg(Aup_avatar, 0xa0, 0xa0, "-cc");
        var Kj;
        ...
        if (Aup_Info) {
          ...
          if (Object.keys(Aup_Info.links).length > 0x0) {
            for (site in Aup_Info.links) {
              if (r.indexOf(site) != -0x1) {
  ...
  function KW() {
    if (u === feed_count) {
      ...
      $getJSONP(Kj + "/posts/summary?alt=json-in-script&max-results=150&start-index=" + (u * 0x96 + 0x1), function (Kz) {
        Kz.feed.entry.each(function (Kc, Kv) {
          if (!Kc.app$control) {
            var Ks = K4(Kc);
            if (Ks.Author === Aup_Name) {
              Aup_Posts_Content += "<div class=\"timeline-month\" data-month=\"" + K3(Ks.FullDate) + " " + Ks.FullDate.substr(0x0, 0x4) + "\">";
              Aup_Posts_Content += "<b class=\"timeline-point hide\"></b>";
              Aup_Posts_Content += "<div class=\"timeline-month-name hide\"><span>" + K3(Ks.FullDate) + " " + Ks.FullDate.substr(0x0, 0x4) + "</span></div>";
              Aup_Posts_Content += "<div class=\"timeline-item\" role=\"article\" data-month=\"" + K3(Ks.FullDate) + " " + Ks.FullDate.substr(0x0, 0x4) + "\">";
              Aup_Posts_Content += "<span class=\"timeline-date\">";
              Aup_Posts_Content += "<b>" + Ks.FullDate.substr(0x8, 0x2) + "</b>";
              Aup_Posts_Content += "<i>" + K3(Ks.FullDate) + " " + Ks.FullDate.substr(0x0, 0x4) + "</i>";
              Aup_Posts_Content += "</span>";
              Aup_Posts_Content += "<b class=\"timeline-point\"></b>";
              Aup_Posts_Content += "<div class=\"timeline-post\">";
              Aup_Posts_Content += "<img class=\"timeline-thumb\" src=\"" + resizeImg(Ks.ImgUrl, 0x48, 0x48, "-cc") + "\"/>";
  ...
  function KB() {
    if (u === feed_count) {
      ...
      AuthorsInfo.each(function (KR, Kj) {
        ...
        Kz += "<span class=\"blog-author-avatar\" style=\"background-image:url(" + resizeImg(Kc, 0x78, 0x78, "-cc") + ")\"></span>";
        Kz += KR.rank ? "<b class=\"blog-author-rank\">" + KR.rank + "</b>" : '';
        Kz += "<div class=\"blog-author-social\"></div>";
        Kz += "<b class=\"blog-author-count\">" + KR.count + " " + trans[0xf] + "</b>";
        Kz += "<a href=\"" + Ks + "\" class=\"blog-author-link\">" + trans[0x13] + "</a>";
        Kz += "</div>";
      ...
      $getJSON("/feeds/posts/summary?alt=json&max-results=150&start-index=" + (u * 0x96 + 0x1), function (KR) {
        KR.feed.entry.each(function (Kj, Kz) {
          var Kc = AuthorsInfo.filter(function (Ks) {
            return Ks.name === Kj.author[0x0].name.$t.toString();
          })[0x0];
          if (Kc) {
            Kc.count += 0x1;
          } else {
            var Kv = {
              name: Kj.author[0x0].name.$t,
              avatar: Kj.author[0x0].gd$image ? Kj.author[0x0].gd$image.src : AltAuthor,
              count: 0x1,
              provided: false
            };
            AuthorsInfo.push(Kv);
  ...
  function Ke() {
    if (_$("#archive-page").found()) {
      Object.keys(h).each(function (Kj, Kz) {
        var Kc = h[Kj];
        var Kv = Math.ceil(Kc / 0x96);
        var Ks = decodeURI(Kj);
        _$(".post-body").append("<div class=\"arp-label\" id=\"l-" + Kz + "\"><div class=\"arp-label-name\"><b>" + Ks + "</b><span class=\"arp-label-count\">" + Kc + " <u>" + trans[0xf] + "</u></span></div></div>");
        if (FeedEnabled && !isPrivate) {
          KR(Kz, 0x0, Ks, Kv);
        }
      });
      function KR(Kj, Kz, Kc, Kv) {
        var Ks = b || S ? "https://www.blogger.com/feeds/" + i : "/feeds";
        $getJSONP(Ks + "/posts/summary/-/" + encodeURIComponent(Kc) + "?alt=json-in-script&max-results=150&start-index=" + (Kz * 0x96 + 0x1), function (Kb) {
          Kb.feed.entry.each(function (KS) {
            if (!KS.app$control) {
              var Km = K4(KS);
              var KN = new String();
              KN += "<div class=\"arp-item\">";
              KN += "<img class=\"arp-thumb\" src=\"" + resizeImg(Km.ImgUrl, 0x48, 0x48) + "\"/>";
              KN += "<span class=\"arp-date\">" + Km.Date + "</span>";
              if (KS.category[0x1] !== undefined) {
    ...
    function Kv(Kb) {
      ...
      function KG() {
        if (Km == 0x0) {
          ...
          _$(".cCount").textContent = Km < 0xa ? '0' + Km : Km;
          Km--;
      ...
      window.onfocus = function () {
        Kj = Km != 0x0 ? setInterval(KG, 0x3e8) : undefined;
      };
    }
    function Ks() {
      clearInterval(Kj);
      _$(".redirect-modal").fadeOut(0x190, function (Kb) {
        Kb.remove();
  ...
  function Ky() {
    ...
    Kc = Kz[Math.floor(Kz.length / 0x2)];
    Kc = KO(Kc, Kj);
    return Kc;
  }
  function KZ() {
    _$(".post-body blockquote:not(.twitter-tweet)").each(function (KR) {
      ...
      if (KR.textContent.length + 0x17 > 0x118) {
        var Kz = KR.textContent.length + 0x17 - 0x118;
        var Kc = KR.textContent.substr(0x0, KR.textContent.length - Kz - 0x5) + "...";
      } else {
        Kc = KR.textContent;
      }
  ...
  function Kq() {
    ...
    window.addEventListener("scroll", function () {
      if (window.scrollY + window.innerHeight > _$(".post-outer").offset().top && !KR || !R && !KR) {
        ...
        let Kb = 0x0;
        let KS;
        Ks.after("<div class=\"see-also\"><strong>" + trans[0x24] + "</strong><ul></ul></div>");
        if (Kv) {
          Kv.remove();
        }
        if (Kz.length == 0x1) {
          KS = "/feeds/posts/summary/-/" + Kz[0x0] + "?alt=json&max-results=6";
        } else {
          if (Kz.length > 0x1) {
            var Kj = Kz.filter(function (KN) {
              return KN.indexOf(" ") == -0x1;
            });
            if (Kj) {
  ...
  function Kw() {
    ...
    window.onscroll = function () {
      if (window.scrollY + window.innerHeight > _$(".topic-related").offset().top && !relExcuted || !R && !relExcuted) {
        ...
        if (FeedEnabled && !isPrivate) {
          if (Kb.length == 0x1) {
            Kj = Kv + "/posts/summary/-/" + Kb[0x0] + "?alt=json-in-script&max-results=" + a;
          } else {
            if (Kb.length > 0x1) {
          ...
          $getJSONP(Kj, function (KF) {
            KG(KF);
            Kf();
            if (KF.feed.entry.length < a + 0x1) {
              KS = a + 0x1 - KF.feed.entry.length;
        ...
        function KG(KF) {
          for (KR = 0x0; KR < KF.feed.entry.length; KR = KR + 0x1) {
            if (!KF.feed.entry[KR].app$control) {
              var KV = K4(KF.feed.entry[KR]);
              if (Kc.indexOf(KV.PostId) == -0x1) {
                Kc.push(KV.PostId);
