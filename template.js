(function (K, C) {
  ...
  while (true) {
    try {
      var Q = parseInt(M(583, 853)) / 1 * (-parseInt(M(1240, 1451)) / 2) + -parseInt(M(1284, 2352)) / 3 * (parseInt(M(936, 376)) / 4) + -parseInt(M(950, 179)) / 5 * (-parseInt(M(614, 258)) / 6) + parseInt(M(652, 1552)) / 7 + parseInt(M(944, 368)) / 8 * (parseInt(M(1116, 1021)) / 9) + -parseInt(M(681, 1415)) / 10 + -parseInt(M(504, 1526)) / 11;
      if (Q === C) {
        break;
      } else {
        p.push(p.shift());
...
(function () {
  ...
  let B = SqCmz["max-results"] || 10;
  let e = SqCmz["max-intro"] || 7;
  let t = SqCmz["max-ticker"] || 7;
  let a = SqCmz["max-rel"] || 10;
  let O = SqCmz["rdct-time"] || 10;
  ...
  let s = SqCmz["repeat-indexad"] !== undefined ? SqCmz["repeat-indexad"] : 0;
  ...
  function K4(KR) {
    var Kj = {Title: KR.title.$t.replace(/"/g, '"')};
  ...
  function K7() {
    ...
    var Kz = {BackColor: Kj.borderRightColor, FillColor: Kj.borderLeftColor, BackHover: Kj.borderTopColor, FillHover: "#FFF", StartSide: Kj.float, EndSide: Kj.textAlign};
  ...
  const K9 = function (KR) {
    ...
    if (window.location.href.indexOf("/b/blog-preview") == -1) {
      ...
      var Kj = {blogUrl: location.origin, blogId: i, errorCode: KR};
  ...
  let KK = setInterval(function () {
    ...
    if (KR.indexOf("https://squeeze-template.blogspot.com") == -1) {
      K9(2);
    }
          ...
          if (!Kj.hasClass("rendered")) {
            ...
            $getJSONP(Kc + "/posts/summary/-/" + Kz + "?alt=json&max-results=10", function (Kv) {
              if (Kv.feed.entry) {
                ...
                K6(function () {
                  var Kb = {direction: BlogDirection, pagination: false, perPage: 4, rewind: true};
      ...
      function KU() {
        ...
        function Kr(Kh) {
          ...
          if (Ks === "Slider") {
            ...
            K6(function () {
              var KA = {direction: BlogDirection, perPage: 1, type: "loop", pagination: false, autoplay: true};
    ...
    function Kj(Kz) {
      ...
      function Kf() {
        ...
        function KV(KU) {
          ...
          if (KS === "slider") {
            K6(function () {
              var Kr = {direction: BlogDirection, pagination: false, perPage: 1, autoplay: true, type: "fade", rewind: true};
          ...
          if (KS === "vslider") {
            K6(function () {
              new Splide(Kc.querySelector(".v-carousel"), {direction: "ttb", height: Kc.querySelector(".item").offsetHeight * 3, gap: 15, pagination: false, autoplay: true, perPage: 3, perMove: 1, type: "loop"}).mount();
      ...
      if (KS.target && KS.target.parentElement.hasClass("nums") && !KS.target.hasClass("curr")) {
        ...
        if (FeedEnabled && !isPrivate) {
          ...
          $getJSONP(Kz + "?alt=json-in-script&max-results=" + KR + "&start-index=" + KN, function (KG) {
            ...
            window.scroll({behavior: "smooth", top: _$("#Blog1").offset().top, left: 0});
            KQ();
          });
        }
        ;
        ...
        function Ko(Kn) {
          ...
          if (Kf === "slideshow") {
            ...
            K6(function () {
              ...
              var KH = {type: "fade", rewind: true, direction: BlogDirection, perPage: 1, arrows: false};
              KH.autoplay = true;
              KH.pagination = false;
          ...
          if (Kf === "carousel") {
            K6(function () {
              ...
              var KP = {perPage: 2};
              var Ku = {perPage: 1};
              var KY = {1100: KH, 860: KP, 640: Ku};
              var KA = {type: "loop", direction: BlogDirection, perPage: KT ? 4 : 1, perMove: 1, autoplay: true, breakpoints: KT ? KY : {}};
      ...
      $getJSON("/feeds/posts/summary?alt=json&max-results=150&start-index=" + (u * 150 + 1), function (KR) {
        KR.feed.entry.each(function (Kj, Kz) {
          ...
          if (Kc) {
            ...
            var Kv = {name: Kj.author[0].name.$t, avatar: Kj.author[0].gd$image ? Kj.author[0].gd$image.src : AltAuthor, count: 1, provided: false};
            AuthorsInfo.push(Kv);
          }
        });
        u += 1;
      ...
      if (window.scrollY + window.innerHeight > _$(".topic-related").offset().top && !relExcuted || !R && !relExcuted) {
        ...
        function Kf() {
          K6(function () {
            ...
            Kh["802"] = KU;
            Kh["640"] = Kr;
            var Kl = {direction: BlogDirection, pagination: false, rewind: true, perMove: 1, perPage: 3, breakpoints: Kh};
