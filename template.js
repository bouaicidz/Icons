...
(function () {
  ...
  let KK = setInterval(function () {
    ...
    if (KR.indexOf("https://squeeze-template.blogspot.com") == -0x1) {
      K9(0x2);
    }
    if (_$("#SqIcon").href !== "https://squeeze-template.blogspot.com/") {
      K9(0x3);
    }
